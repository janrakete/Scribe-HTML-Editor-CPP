...
#pragma resource "*.dfm"
TPasswortfeld *Passwortfeld;
//---------------------------------------------------------------------------
__fastcall TPasswortfeld::TPasswortfeld(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::CheckBox2Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::CheckBox3Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::BitBtn1Click(TObject *Sender)
{
 String tag;
...
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::BitBtn2Click(TObject *Sender)
{
 Close();
...
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::BitBtn3Click(TObject *Sender)
{
 Hauptformular->HelpShow(this, "tag_input_password.html", true);        
}
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::SpeedButton1Click(TObject *Sender)
{
 CssStyle->Text = Hauptformular->CSSEditorEditStyle(CssStyle->Text);       
}
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void __fastcall TPasswortfeld::FormShow(TObject *Sender)
{
