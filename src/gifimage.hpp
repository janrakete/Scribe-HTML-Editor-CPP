...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall GIFException(int Ident, Extended Dummy) : Graphics::EInvalidGraphic(
		Ident, Dummy) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall GIFException(int Ident, const System::TVarRec * Args
		, const int Args_Size) : Graphics::EInvalidGraphic(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall GIFException(int Ident, int AHelpContext) : Graphics::EInvalidGraphic(
		Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall GIFException(int Ident, const System::TVarRec * 
		Args, const int Args_Size, int AHelpContext) : Graphics::EInvalidGraphic(Ident, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
