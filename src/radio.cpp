...
//---------------------------------------------------------------------------
__fastcall TRadiobutton::TRadiobutton(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TRadiobutton::FormClose(TObject *Sender,
      TCloseAction &Action)
{
...
void __fastcall TRadiobutton::FormShow(TObject *Sender)
{
 EventsTab->TabVisible = Hauptformular->editor_events_tab;
...
void __fastcall TRadiobutton::BitBtn1Click(TObject *Sender)
{
 String tag;
...
void __fastcall TRadiobutton::BitBtn2Click(TObject *Sender)
{
 Close();
...
void __fastcall TRadiobutton::BitBtn3Click(TObject *Sender)
{
 Hauptformular->HelpShow(this, "tag_input_radio.html", true);        
}
//---------------------------------------------------------------------------

void __fastcall TRadiobutton::SpeedButton1Click(TObject *Sender)
{
